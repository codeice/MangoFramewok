define(['../../modules/ctrlModule', '../../directives/dirUploadify', '../../directives/dirUploadImage', '../../directives/dirUploadFile'], function (module) {
    ...
    module.config(['$stateProvider', function ($stateProvider) {
        $stateProvider
            ...
            {
                url: '/test',
                templateUrl: 'app/controllers/test/test.html?nc=' + Math.random(),
                controller: 'testCtrl'
            })
            .state('test2',
            {
                url: '/test2',
                templateUrl: 'app/controllers/test/test2.html',
                controller: 'testChildCtrl'
            })
            .state('test2.child1',
            {
                url: '/child1',
                templateUrl: 'app/controllers/test/child1.html',
                controller: 'testChildCtrl'
            })
                    .state('test2.child2',
            {
                url: '/child2',
                templateUrl: 'app/controllers/test/child2.html',
                controller: 'testChildCtrl'
            });
    }]);
