...
({
    ...
    paths: {
        ...
        'colorbox': 'libs/assets/js/jquery.colorbox-min',
        ...
        'laydate': 'libs/laydate/laydate.min',
    ...
    optimize: "uglify2", //uglify 或者None
    name: "app/main",  //指定入口 函数
    out: 'build/all-0922.js',  //压缩完的输出函数（每次生成新文件名，自行修改配置）
})
