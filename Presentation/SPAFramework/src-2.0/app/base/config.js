(function () {
  ...
  window.ossConfig = {
        ossEndpoint: 'oss-cn-shanghai',
        imgEndpoint: 'img-cn-shanghai.aliyuncs.com',
        accessKeyId: 'bRUqWdypn33Ec8YC',
        accessKeySecret: 'R2M3bMbSEFkq6gLoevmFDdUYyAvapP',
        imageBucket: 'saiquaner2-image-test',
        videoBucket: 'saiquaner2-video-test',
        defaultBucket: 'saiquaner2-test'
    };
